...
export default {
	install: function (Vue) {
		Vue.prototype.$request2 = function (url, config) {
		...
		Vue.prototype.$get2 = function (url, config) {
			config = Object.assign({}, config, { method: 'get' });
			return this.$request2(url, config)
		};
		Vue.prototype.$post2 = function (url, config) {
