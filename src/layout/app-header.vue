<template>
  <div class="header">
    ...
    <div class="user">
      <!-- 告警 -->
      <div v-if="alarmIf" class="alarm" @click="click">
        <div class="center">{{ alarmTotal }}</div>
        <img src="../assets/images/alarm2.png" class="alarmImg">
      ...
      <div class="item user-info">
        <el-dropdown trigger="click" class="user-info-dropdown" @command="activeUserDropdown">
          ...
          <div class="el-dropdown-link">
            <i class="icon iconfont icon-gerenzhongxin_xuanzhong"></i>
            {{ user.name }}
      ...
      <div class="item" title="退出系统" @click="logout">
        <i class="icon iconfont icon-exit" title="退出系统"></i>
      </div>
    </div>
    ...
    <!--告警dialog -->
    <el-dialog width="50%" append-to-body title="告警信息" :visible.sync="alarmVisible" class="alarmDialog">
      <el-table stripe tooltip-effect="dark" ref="tableElement" :data="alarmData" v-loading="alarmLoading">
        <el-table-column label="异常等级" prop="level" align="center" width="130">
        </el-table-column>
        <el-table-column label="异常类型" prop="type" align="center">
        </el-table-column>
        <el-table-column label="异常内容" prop="detail" align="center">
        </el-table-column>
        <el-table-column label="是否提交至总线" prop="submit_status" align="center">
...
//      logo: "",
    ...
    methods: {
        ...
        this.$refs["pwdForm"].validate((valid) => {
          if (valid) {
            ...
            this.$put('/password', {
              ...
              if (data === true) {
                this.$message.success({message: '密码修改成功', type: 'success'});
      ...
      handleSizeChange(val) {
          this.pageSize = val;
          this.alarmData = this.platformAlarms.slice((this.currentPage - 1) * this.pageSize, this.currentPage * this.pageSize)
      },
      //切换分页
      ...
      load() {
          ...
          this.$post('/action', {
              ...
              if(Array.isArray(data)) {
                  ...
                  this.alarmTotal = this.total;
                  this.platformAlarms = data;
                  this.alarmData = this.platformAlarms.slice(0,5);
